"""
Django settings for little_wave_45298 project.
...
ROOT_URLCONF = 'little_wave_45298.urls'
...
WSGI_APPLICATION = 'little_wave_45298.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "little_wave_45298 API",
    "DESCRIPTION": "API documentation for little_wave_45298 App",
    "VERSION": "v1",
}
